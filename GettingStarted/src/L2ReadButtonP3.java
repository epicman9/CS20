...
public class L2ReadButtonP3 
{
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        while(true)
        {
        	if(statelastframe != redButton.getState()) //checks if previous state is different from current state
        	{
                System.out.println("The buttons state has changed from " + statelastframe + " to " + redButton.getState());   
